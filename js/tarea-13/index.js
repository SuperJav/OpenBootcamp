...
const sumax = suma(23,22);
console.log(chalk.blue(`La Suma es: ${sumax}`));

const multiplicarx = multiplicar(2,34);
console.log(chalk.yellow(`La Multiplicacion es: ${multiplicarx}`));
